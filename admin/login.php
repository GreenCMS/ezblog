...
<link rel='stylesheet' id='wp-admin-css' href='./css/wp-admin.css'
	type='text/css' media='all' />
<link rel='stylesheet' id='buttons-css' href='./css/buttons.min.css'
	type=' text/css' media='all' />
...
<body class="login login-action-login wp-core-ui">
	<div id="login">
		<h1>
			<a href="http://blog.zts1993.com" title="基于 EZ-BLOG">EZ-Blog</a>
		</h1>
		...
		<form name="loginform" id="loginform" action="login.php" method="post">
			<p>
				<label for="username">用户名<br /> <input type="text" name="username"
					id="user_login" class="input" value="" size="20" /></label>
			</p>
			<p>
				<label for="password">密码<br /> <input type="password"
					name="password" id="user_pass" class="input" value="" size="20" /></label>
			</p>
			<p class="forgetmenot">
				<label for="rememberme"><input name="rememberme" type="checkbox"
					id="rememberme" value="forever" /> 记住我的登录信息</label>
			</p>
			<p class="submit">
		...
		<p id="nav">
			<a href="http://blog.zts1993.com/wp-login.php?action=lostpassword"
				title="找回密码">忘记密码？</a>
		</p>
...
if(typeof wpOnload=='function')wpOnload();
		...
		<p id="backtoblog">
			<a href="../index.php" title="不知道自己在哪？">&larr; 回到 EZ-Blog</a>
		</p>
